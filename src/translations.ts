...
👉 Write to me or schedule a call at **[freddydev.net](https://freddydev.net)** to evaluate how to automate your team's processes.`,
    ...
    enableComments: true,
      ...
      // ============================================================
      // NOTICIAS DE BADABUN.COM - VIRAL CONTENT (ids 200-220)
      {
        id: '200',
        contentType: 'news',
        slug: 'si-ves-esta-linea-roja-en-tu-hijo-ve-al-medico-el-mismo-dia',
        titleEs: 'Alerta médica: Señales rojas en la piel del bebé que requieren atención inmediata',
        titleEn: 'Medical alert: Red lines on baby skin requiring immediate attention',
        excerptEs: 'La línea roja en la piel del recién nacido puede indicar condiciones médicas que requieren evaluación inmediata por parte del pediatra.',
        excerptEn: 'Red lines on newborn skin may indicate medical conditions requiring immediate pediatric evaluation.',
        contentEs: '<h1>Alerta médica: Señales rojas en la piel del bebé</h1><p>Este tipo de información circula frecuentemente en redes sociales como mensajes de alerta para padres. Según la Organización Mundial de la Salud (OMS), ciertas marcas cutáneas pueden indicar infecciones, alergias o condiciones dermatológicas.</p><h2>¿Cuándo preocuparse?</h2><p>Cuando veas una línea roja continua en la piel del bebé, especialmente si va acompañada de picazón, enrojecimiento o infección, consulta a un pediatra de inmediato.</p>',
        contentEn: '<h1>Medical alert: Red lines on baby skin</h1><p>This type of information circulates frequently on social media as alert messages for parents. According to the World Health Organization (WHO), certain skin markings may indicate infections, allergies, or dermatological conditions.</p><h2>When to worry?</h2><p>When you see a continuous red line on the baby skin, especially if accompanied by itching, redness, or infection, consult a pediatrician immediately.</p>',
        date: '2026-07-25',
        readTimeEs: '3 min de lectura',
        readTimeEn: '3 min read',
        imageUrl: 'https://badabun.com/images/alerta-bebe-linea-roja.jpg',
        imageCaption: 'Ilustración médica de señales de alerta en bebés',
        categoryEs: 'Salud',
        categoryEn: 'Health',
        enableComments: true,
        views: 1250,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/si-ves-esta-linea-roja-en-tu-hijo-ve-al-medico-el-mismo-dia',
        breaking: true
      },
      {
        id: '201',
        contentType: 'news',
        slug: 'es-pecado-tomar-alcohol-esto-dice-la-biblia',
        titleEs: '¿Es pecado tomar alcohol? Esto dice la Biblia',
        titleEn: 'Is drinking alcohol a sin? What the Bible says',
        excerptEs: 'Distintas interpretaciones religiosas sobre el alcohol han evolucionado a lo largo de la historia, con énfasis en contexto cultural y social.',
        excerptEn: 'Different religious interpretations about alcohol have evolved throughout history, with emphasis on cultural and social context.',
        contentEs: '<h1>¿Es pecado tomar alcohol?</h1><p>La Biblia menciona el alcohol en varios pasajes, principalmente en textos hebreos y griegos originales. Pasajes como Proverbios 20:1 indican: "El alcohol es malo para el hombre, la bebida fuerte es malo para el rey". Sin embargo, otros pasajes muestran a Jesús transformando agua en vino en Caná.</p><h2>Contexto histórico</h2><p>En la cultura bíblica, el alcohol se usaba como parte de la vida cotidiana, pero su consumo excesivo era condenado.</p>',
        contentEn: '<h1>Is drinking alcohol a sin?</h1><p>The Bible mentions alcohol in several passages, primarily in original Hebrew and Greek texts. Passages like Proverbs 20:1 state: "Alcohol is bad for man, strong drink is bad for the king". However, other passages show Jesus transforming water into wine at Cana.</p><h2>Historical context</h2><p>In biblical culture, alcohol was used as part of daily life, but excessive consumption was condemned.</p>',
        date: '2026-07-25',
        readTimeEs: '4 min de lectura',
        readTimeEn: '4 min read',
        imageUrl: 'https://badabun.com/images/biblia-alcohol.jpg',
        imageCaption: 'Manuscritos antiguos con texto sobre alcohol',
        categoryEs: 'Religión',
        categoryEn: 'Religion',
        enableComments: true,
        views: 2100,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/es-pecado-tomar-alcohol-esto-dice-la-biblia'
      },
      {
        id: '202',
        contentType: 'news',
        slug: 'es-urgente-que-todas-las-mamas-sepan-esto',
        titleEs: 'Es urgente que todas las mamás sepan esto',
        titleEn: 'It is urgent that all mothers know this',
        excerptEs: 'Este artículo aborda aspectos clave del desarrollo cognitivo, emocional y físico en la primera infancia.',
        excerptEn: 'This article addresses key aspects of cognitive, emotional, and physical development in early childhood.',
        contentEs: '<h1>Guía práctica para madres</h1><p>El desarrollo infantil es un proceso complejo que requiere atención especializada. Las primeras etapas de vida son críticas para el crecimiento saludable del niño.</p><h2>Desarrollo motor</h2><p>Los hitos como el primer paso, la primera palabra y la coordinación mano-ojo son indicadores importantes del desarrollo neurológico.</p>',
        contentEn: '<h1>Practical guide for mothers</h1><p>Child development is a complex process that requires specialized attention. The first stages of life are critical for the healthy growth of the child.</p><h2>Motor development</h2><p>Milestones like first steps, first words, and hand-eye coordination are important indicators of neurological development.</p>',
        date: '2026-07-25',
        readTimeEs: '5 min de lectura',
        readTimeEn: '5 min read',
        imageUrl: 'https://badabun.com/images/mamas-conocer-esto.jpg',
        imageCaption: 'Fotos reales de madres con sus hijos en actividades lúdicas',
        categoryEs: 'Familia',
        categoryEn: 'Family',
        enableComments: true,
        views: 1800,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/es-urgente-que-todas-las-mamas-sepan-esto'
      },
      {
        id: '202',
        contentType: 'news',
        slug: 'antes-de-que-tu-hijo-maneje-solo-hazle-estas-4-preguntas',
        titleEs: 'Antes de que tu hijo maneje solo, hazle estas 4 preguntas',
        titleEn: 'Before letting your child drive alone, ask these 4 questions',
        excerptEs: 'La independencia motriz requiere evaluación de responsabilidad, concentración y juicio.',
        excerptEn: 'Motor independence requires evaluation of responsibility, concentration, and judgment.',
        contentEs: '<h1>Preparación para la conducción independiente</h1><p>Antes de permitir que tu hijo maneje solo, es fundamental evaluar su preparación. La conducción no es solo un acto técnico, sino un compromiso de seguridad.</p><h2>Pregunta clave</h2><p>¿Entiende tu hijo los riesgos en la carretera? ¿Sabe cómo reaccionar ante situaciones de emergencia?</p>',
        contentEn: '<h1>Preparation for independent driving</h1><p>Before allowing your child to drive alone, it is essential to evaluate their preparation. Driving is not just a technical act, but a safety commitment.</p><h2>Key question</h2><p>Does your child understand the risks on the road? Do they know how to react in emergency situations?</p>',
        date: '2026-07-25',
        readTimeEs: '3 min de lectura',
        readTimeEn: '3 min read',
        imageUrl: 'https://badabun.com/images/hijo-maneje-solo.jpg',
        imageCaption: 'Joven aprendiendo a conducir con supervisión',
        categoryEs: 'Conducción',
        categoryEn: 'Driving',
        enableComments: true,
        views: 980,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/antes-de-que-tu-hijo-maneje-solo-hazle-estas-4-preguntas'
      },
      {
        id: '203',
        contentType: 'news',
        slug: 'mexicano-que-hizo-que-el-mundo-entero-se-enamorara-de-nuestra-cultura',
        titleEs: 'El mexicano que hizo que el mundo entero se enamorara de nuestra cultura',
        titleEn: 'The Mexican who made the world fall in love with our culture',
        excerptEs: 'El arte, la gastronomía y la música mexicana han ganado reconocimiento mundial en las últimas décadas.',
        excerptEn: 'Mexican art, cuisine, and music have gained worldwide recognition in recent decades.',
        contentEs: '<h1>Cultura mexicana global</h1><p>La influencia de la cultura mexicana en el mundo especialmente en arte, gastronomía y música es un fenómeno creciente. Desde Frida Kahlo hasta la música ranchera, México ha dejado su huella en la cultura global.</p><h2>Exportaciones culturales</h2><p>El turismo cultural y el intercambio artístico han impulsado el reconocimiento internacional de la cultura mexicana.</p>',
        contentEn: '<h1>Mexican culture globally</h1><p>The influence of Mexican culture, especially in art, cuisine, and music, is a growing phenomenon. From Frida Kahlo to ranchera music, Mexico has left its mark on global culture.</p><h2>Cultural exports</h2><p>Cultural tourism and artistic exchange have promoted international recognition of Mexican culture.</p>',
        date: '2026-07-25',
        readTimeEs: '4 min de lectura',
        readTimeEn: '4 min read',
        imageUrl: 'https://badabun.com/images/cultura-mexicana.jpg',
        imageCaption: 'Fotos históricas de artistas mexicanos internacionales',
        categoryEs: 'Cultura',
        categoryEn: 'Culture',
        enableComments: true,
        views: 1560,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/mexicano-que-hizo-que-el-mundo-entero-se-enamorara-de-nuestra-cultura'
      },
      {
        id: '204',
        contentType: 'news',
        slug: 'mia-colucci-y-miguel-se-dicen-todo-22-anos-despues',
        titleEs: 'Mía Colucci y Miguel se dicen TODO 22 años después',
        titleEn: 'Mía Colucci and Miguel say everything again after 22 years',
        excerptEs: 'La cantante Mía Colucci y su exnovio Miguel han mantenido una relación pública especial durante 22 años.',
        excerptEn: 'Singer Mía Colucci and her ex-boyfriend Miguel have maintained a special public relationship for 22 years.',
        contentEs: '<h1>Reencuentro de Mía Colucci y Miguel</h1><p>Dos décadas después de su separación, Mía Colucci y Miguel han revelado detalles íntimos de su relación en entrevistas recientes.</p><h2>Impacto en la cultura popular</h2><p>Su historia ha generado gran interés en redes sociales y medios de entretenimiento.</p>',
        contentEn: '<h1>Reunion of Mía Colucci and Miguel</h1><p>22 years after their separation, Mía Colucci and Miguel have revealed intimate details of their relationship in recent interviews.</p><h2>Impact on pop culture</h2><p>Their story has generated great interest on social media and entertainment media.</p>',
        date: '2026-07-25',
        readTimeEs: '3 min de lectura',
        readTimeEn: '3 min read',
        imageUrl: 'https://badabun.com/images/mia-colucci-miguel.jpg',
        imageCaption: 'Fotos de ambos artistas juntos',
        categoryEs: 'Entretenimiento',
        categoryEn: 'Entertainment',
        enableComments: true,
        views: 3200,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/mia-colucci-y-miguel-se-dicen-todo-22-anos-despues'
      },
      {
        id: '205',
        contentType: 'news',
        slug: '3-habitos-que-pueden-ayudar-a-reducir-el-riesgo-de-cancer',
        titleEs: '3 hábitos que pueden ayudar a reducir el riesgo de cáncer',
        titleEn: '3 habits that can help reduce cancer risk',
        excerptEs: 'Cambios en el estilo de vida tienen un impacto significativo en la reducción del riesgo de desarrollar cáncer.',
        excerptEn: 'Lifestyle changes have a significant impact on reducing the risk of developing cancer.',
        contentEs: '<h1>Prevención del cáncer</h1><p>La evidencia científica muestra que ciertos hábitos cotidianos pueden reducir significativamente el riesgo de cáncer. La organización mundial de la salud recomienda cambios en la dieta, el ejercicio y el control del estrés.</p><h2>Hábitos clave</h2><p>Incluir más frutas y vegetales, mantener un peso saludable y evitar el tabaco son tres pilares fundamentales en la prevención oncológica.</p>',
        contentEn: '<h1>Cancer prevention</h1><p>Scientific evidence shows that certain daily habits can significantly reduce the risk of cancer. The World Health Organization recommends lifestyle changes in diet, exercise, and stress management.</p><h2>Key habits</h2><p>Including more fruits and vegetables, maintaining a healthy weight, and avoiding tobacco are three fundamental pillars in oncological prevention.</p>',
        date: '2026-07-25',
        readTimeEs: '4 min de lectura',
        readTimeEn: '4 min read',
        imageUrl: 'https://badabun.com/images/habitos-reducir-cancer.jpg',
        imageCaption: 'Ilustraciones de hábitos saludables',
        categoryEs: 'Salud',
        categoryEn: 'Health',
        enableComments: true,
        views: 2450,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/3-habitos-que-pueden-ayudar-a-reducir-el-riesgo-de-cancer'
      },
      {
        id: '206',
        contentType: 'news',
        slug: 'una-esposa-con-iniciativa-tiene-un-poder-que-pocas-conocen',
        titleEs: 'Una esposa con iniciativa tiene un poder que pocas conocen',
        titleEn: 'An initiative wife has a power that few know',
        excerptEs: 'Las mujeres con iniciativa empresarial y social generan un impacto positivo en sus familias y comunidades.',
        excerptEn: 'Women with initiative in business and social generating positive impact on families and communities.',
        contentEs: '<h1>El poder de la iniciativa femenina</h1><p>La capacidad de actuar con iniciativa es una característica que ha demostrado ser transformadora en contextos familiares y profesionales.</p><h2>Ejemplos reales</h2><p>Desde emprendimientos locales hasta proyectos comunitarios, las mujeres con iniciativa han sido motor de cambio en sus entornos.</p>',
        contentEn: '<h1>The power of female initiative</h1><p>The ability to act with initiative is a trait that has proven to be transformative in family and professional contexts.</p><h2>Real examples</h2><p>From local ventures to community projects, women with initiative have been the motor of change in their environments.</p>',
        date: '2026-07-25',
        readTimeEs: '3 min de lectura',
        readTimeEn: '3 min read',
        imageUrl: 'https://badabun.com/images/esposa-con-iniciativa.jpg',
        imageCaption: 'Fotos reales de familias y comunidades',
        categoryEs: 'Familia',
        categoryEn: 'Family',
        enableComments: true,
        views: 1340,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/una-esposa-con-iniciativa-tiene-un-poder-que-pocas-conocen'
      },
      {
        id: '207',
        contentType: 'news',
        slug: 'dejo-ir-a-su-hija-a-una-fiesta-y-esto-fue-lo-que-paso',
        titleEs: 'Dejó ir a su hija a una fiesta y esto fue lo que pasó',
        titleEn: 'Let her go to a party and this is what happened',
        excerptEs: 'Un caso de confianza y supervisión que generó resultados positivos inesperados.',
        excerptEn: 'A case of trust and supervision that generated unexpected positive results.',
        contentEs: '<h1>Confianza parental</h1><p>Permitir que los hijos salgan con supervisión adecuada puede generar crecimiento personal y social.</p><h2>El resultado</h2><p>La experiencia demostró que la confianza bien aplicada puede fortalecer relaciones familiares y permitir el desarrollo independiente.</p>',
        contentEn: '<h1>Parental trust</h1><p>Allowing children to go out with proper supervision can generate personal and social growth.</p><h2>The result</h2><p>The experience demonstrated that properly applied trust can strengthen family relationships and allow independent development.</p>',
        date: '2026-07-25',
        readTimeEs: '2 min de lectura',
        readTimeEn: '2 min read',
        imageUrl: 'https://badabun.com/images/fiesta-hija.jpg',
        imageCaption: 'Fotos de eventos sociales familiares',
        categoryEs: 'Familia',
        categoryEn: 'Family',
        enableComments: true,
        views: 890,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/dejo-ir-a-su-hija-a-una-fiesta-y-esto-fue-lo-que-paso'
      },
      {
        id: '208',
        contentType: 'news',
        slug: 'haz-esto-antes-de-darle-una-tablet-o-celular-a-tus-hijos',
        titleEs: 'Haz esto ANTES de darle una tablet o celular a tus hijos',
        titleEn: 'Do this BEFORE giving your children a tablet or phone',
        excerptEs: 'La introducción de dispositivos digitales en la vida infantil requiere establecer límites y expectativas.',
        excerptEn: 'The introduction of digital devices in a child\'s life requires establishing limits and expectations.',
        contentEs: '<h1>Disciplina digital para niños</h1><p>Antes de regalar un dispositivo digital, es fundamental establecer reglas claras sobre su uso. La pantalla no necesita ser enemiga, pero sí requiere equilibrio.</p><h2>Recomendaciones</h2><p>Establecer horarios, usar controles parentales y fomentar actividades offline son pasos clave para una inserción saludable de la tecnología.</p>',
        contentEn: '<h1>Digital discipline for children</h1><p>Before giving a digital device, it is essential to establish clear rules about its use. The screen does not need to be an enemy, but it does require balance.</p><h2>Recommendations</h2><p>Setting schedules, using parental controls, and promoting offline activities are key steps for healthy technology insertion.</p>',
        date: '2026-07-25',
        readTimeEs: '3 min de lectura',
        readTimeEn: '3 min read',
        imageUrl: 'https://badabun.com/images/tablet-hijos.jpg',
        imageCaption: 'Fotos de niños usando dispositivos digitales',
        categoryEs: 'Tecnología',
        categoryEn: 'Technology',
        enableComments: true,
        views: 1980,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/haz-esto-antes-de-darle-una-tablet-o-celular-a-tus-hijos'
      },
      {
        id: '209',
        contentType: 'news',
        slug: '7-datos-del-dictador-de-nicaragua-que-te-van-a-dar-rabia',
        titleEs: '7 datos del dictador de Nicaragua que te van a dar rabia',
        titleEn: '7 facts about the Nicaraguan dictator that will make you angry',
        excerptEs: 'El gobierno de Daniel Ortega ha estado bajo críticas por violar derechos humanos y suprimir libertades democráticas.',
        excerptEn: 'The government of Daniel Ortega has been under criticism for violating human rights and suppressing democratic freedoms.',
        contentEs: '<h1>Situación en Nicaragua</h1><p>Los últimos años han visto un deterioro significativo en las libertades democráticas en Nicaragua. Las elecciones han sido cuestionadas y la oposición ha sido reprimida.</p><h2>Datos clave</h2><p>La presión internacional ha aumentado mientras que la población sigue lidiando con limitaciones draconianas a la libertad de expresión.</p>',
        contentEn: '<h1>Situation in Nicaragua</h1><p>The last years have seen a significant deterioration in democratic freedoms in Nicaragua. Elections have been questioned and the opposition has been repressed.</p><h2>Key facts</h2><p>International pressure has increased while the population continues to deal with draconian limitations on freedom of expression.</p>',
        date: '2026-07-25',
        readTimeEs: '4 min de lectura',
        readTimeEn: '4 min read',
        imageUrl: 'https://badabun.com/images/dictador-nicaragua.jpg',
        imageCaption: 'Fotos del gobierno y protestas en Nicaragua',
        categoryEs: 'Política',
        categoryEn: 'Politics',
        enableComments: true,
        views: 1670,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/7-datos-del-dictador-de-nicaragua-que-te-van-a-dar-rabia'
      },
      {
        id: '210',
        contentType: 'news',
        slug: 'colombia-prefiere-proteger-la-vida-de-millones-de-animales-antes-que-ganar-mas-dinero-con-el-petroleo',
        titleEs: 'Colombia prefirió proteger la vida de millones de animales antes que ganar más dinero con el petróleo',
        titleEn: 'Colombia chose to protect the lives of millions of animals before making more money from oil',
        excerptEs: 'La decisión de Colombia de proteger ecosistemas frente a proyectos petroleros refleja prioridades ambientales.',
        excerptEn: 'Colombia\'s decision to protect ecosystems against oil projects reflects environmental priorities.',
        contentEs: '<h1>Decisión ambiental de Colombia</h1><p>La protección de hábitos naturales frente a proyectos extractivos es una elección que cuesta, pero que beneficia a futuras generaciones.</p><h2>Impacto ecológico</h2><p>Este tipo de decisiones muestra un compromiso con la sostenibilidad a largo plazo sobre ganancias inmediatas.</p>',
        contentEn: '<h1>Colombia\'s environmental decision</h1><p>Protecting natural habitats against extraction projects is a costly choice, but one that benefits future generations.</p><h2>Ecological impact</h2><p>This type of decision shows a commitment to long-term sustainability over immediate gains.</p>',
        date: '2026-07-25',
        readTimeEs: '3 min de lectura',
        readTimeEn: '3 min read',
        imageUrl: 'https://badabun.com/images/colombia-animales.jpg',
        imageCaption: 'Fotos de fauna y flora en Colombia',
        categoryEs: 'Medio Ambiente',
        categoryEn: 'Environment',
        enableComments: true,
        views: 1420,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/colombia-prefiere-proteger-la-vida-de-millones-de-animales-antes-que-ganar-mas-dinero-con-el-petroleo'
      },
      {
        id: '211',
        contentType: 'news',
        slug: 'haaland-y-vozinha-los-dos-mas-amados-del-mundial',
        titleEs: 'Haaland y Vozinha: los dos más amados del Mundial. Lograron más de 50 millones de seguidores nuevos',
        titleEn: 'Haaland and Vozinha: the two most loved of the World Cup. They gained over 50 million new followers',
        excerptEs: 'Erling Haaland y Vozinha no solo destacaron en el campo, sino también en redes sociales con más de 50 millones de nuevos seguidores.',
        excerptEn: 'Erling Haaland and Vozinha stood out on the field and on social media with over 50 million new followers.',
        contentEs: '<h1>Impacto social del fútbol</h1><p>Los jugadores más destacados del Mundial 2026 han conquistado tanto públicos deportivos como masas globales de fanáticos.</p><h2>Crecimiento en redes</h2><p>El éxito en el campo se tradujo en un crecimiento exponencial en sus cuentas oficiales de redes sociales.</p>',
        contentEn: '<h1>Social impact of football</h1><p>The standout players of the 2026 World Cup have won over both sports fans and massive global audiences.</p><h2>Growth on social</h2><p>Success on the field translated into exponential growth on their official social media accounts.</p>',
        date: '2026-07-25',
        readTimeEs: '2 min de lectura',
        readTimeEn: '2 min read',
        imageUrl: 'https://badabun.com/images/haaland-vozinha.jpg',
        imageCaption: 'Fotos de ambos jugadores del Mundial',
        categoryEs: 'Deportes',
        categoryEn: 'Sports',
        enableComments: true,
        views: 4500,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/haaland-y-vozinha-los-dos-mas-amados-del-mundial'
      },
      {
        id: '212',
        contentType: 'news',
        slug: '7-datos-del-hijo-de-crono-sera-campeon-del-mundo',
        titleEs: '7 datos del hijo de CR7. ¿Él será campeón del mundo?',
        titleEn: '7 facts about Cristiano Ronaldo\'s son. Will he be world champion?',
        excerptEs: 'El hijo de Cristiano Ronaldo, Cristiano Jr., muestra talento y relevancia mediática creciente.',
        excerptEn: 'Cristiano Ronaldo\'s son, Cristiano Jr., shows growing talent and media relevance.',
        contentEs: '<h1>El hijo de CR7 en el foco</h1><p>Cristiano Jr. ha ganado atención en redes sociales y medios deportivos por su habilidad y carisma.</p><h2>Futuro profesional</h2><p>Las expectativas sobre su carrera futbolística son altas, pero también hay interés en su vida personal y familiar.</p>',
        contentEn: '<h1>Cristiano Jr. in the spotlight</h1><p>Cristiano Jr. has gained attention on social media and sports media for his skill and charisma.</p><h2>Professional future</h2><p>Expectations about his future football career are high, but there is also interest in his personal and family life.</p>',
        date: '2026-07-25',
        readTimeEs: '3 min de lectura',
        readTimeEn: '3 min read',
        imageUrl: 'https://badabun.com/images/crono-hijo.jpg',
        imageCaption: 'Fotos del hijo de Cristiano Ronaldo',
        categoryEs: 'Deportes',
        categoryEn: 'Sports',
        enableComments: true,
        views: 2800,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/7-datos-del-hijo-de-crono-sera-campeon-del-mundo'
      },
      {
        id: '213',
        contentType: 'news',
        slug: 'por-que-el-mundo-entero-ama-a-cucurella',
        titleEs: '¿Por qué el mundo entero ama a Cucurella?',
        titleEn: 'Why the whole world loves Cucurella',
        excerptEs: 'El defensor del Barcelona y selección española ha ganado popularidad por su actitud positiva y habilidades técnicas.',
        excerptEn: 'The Barcelona defender and Spanish national team has gained popularity for his positive attitude and technical skills.',
        contentEs: '<h1>El fenómeno Cucurella</h1><p>Desde su llegada al Barcelona, Cucurella ha cautivado tanto a jugadores como a fanáticos con su actitud y desempeño.</p><h2>Factores de popularidad</h2><p>Su humildad, trabajo en equipo y habilidades defensivas lo convierten en un jugador muy querido.</p>',
        contentEn: '<h1>The Cucurella phenomenon</h1><p>Since his arrival at Barcelona, Cucurella has captivated both players and fans with his attitude and performance.</p><h2>Factors of popularity</h2><p>His humility, teamwork, and defensive skills make him a very beloved player.</p>',
        date: '2026-07-25',
        readTimeEs: '2 min de lectura',
        readTimeEn: '2 min read',
        imageUrl: 'https://badabun.com/images/cucurella.jpg',
        imageCaption: 'Fotos del defensor español',
        categoryEs: 'Deportes',
        categoryEn: 'Sports',
        enableComments: true,
        views: 1950,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/por-que-el-mundo-entero-ama-a-cucurella'
      },
      {
        id: '214',
        contentType: 'news',
        slug: 'estudiantes-reparan-autos-usados-y-les-regalan-a-madres-solteras',
        titleEs: 'Estudiantes reparan autos usados y les regalan a madres solteras',
        titleEn: 'Students repair used cars and give them to single mothers',
        excerptEs: 'Un proyecto de estudiantes ha transformado vidas al reparar y donar vehículos a familias necesitadas.',
        excerptEn: 'A student project has transformed lives by repairing and donating vehicles to needy families.',
        contentEs: '<h1>Iniciativa estudiantil</h1><p>Un grupo de estudiantes universitarios se unieron para reparar autos usados y donarlos a madres solteras en situación vulnerable.</p><h2>Impacto social</h2><p>Este tipo de iniciativas demuestran el poder transformador de la solidaridad juvenil.</p>',
        contentEn: '<h1>Student initiative</h1><p>A group of university students joined forces to repair used cars and donate them to single mothers in vulnerable situations.</p><h2>Social impact</h2><p>This type of initiative demonstrates the transformative power of youth solidarity.</p>',
        date: '2026-07-25',
        readTimeEs: '4 min de lectura',
        readTimeEn: '4 min read',
        imageUrl: 'https://badabun.com/images/estudiantes-madres-solteras.jpg',
        imageCaption: 'Fotos del evento de entrega de autos',
        categoryEs: 'Solidaridad',
        categoryEn: 'Solidarity',
        enableComments: true,
        views: 2100,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/estudiantes-reparan-autos-usados-y-les-regalan-a-madres-solteras'
      },
      {
        id: '215',
        contentType: 'news',
        slug: '3-datos-de-la-novia-de-yamal-que-todas-las-mujeres-deben-conocer',
        titleEs: '3 datos de la novia de Yamal que todas las mujeres deben conocer',
        titleEn: '3 facts about Yamal\'s girlfriend that all women should know',
        excerptEs: 'La pareja del fenómeno del fútbol Lamine Yamal ha mantenido un perfil público limitado.',
        excerptEn: 'Lamine Yamal\'s partner has maintained a limited public profile.',
        contentEs: '<h1>Vida personal de Yamal</h1><p>Aunque Yamal es un fenómeno del fútbol, su pareja ha preferido mantener cierta privacidad sobre su vida personal.</p><h2>Interés público</h2><p>La curiosidad por su relación refleja el equilibrio entre la fama del jugador y la privacidad de su pareja.</p>',
        contentEn: '<h1>Yamal\'s personal life</h1><p>Although Yamal is a football phenomenon, his partner has preferred to maintain some privacy about her personal life.</p><h2>Public interest</h2><p>The curiosity about their relationship reflects the balance between the player\'s fame and his partner\'s privacy.</p>',
        date: '2026-07-25',
        readTimeEs: '2 min de lectura',
        readTimeEn: '2 min read',
        imageUrl: 'https://badabun.com/images/novia-yamal.jpg',
        imageCaption: 'Fotos de la pareja del fenómeno del fútbol',
        categoryEs: 'Deportes',
        categoryEn: 'Sports',
        enableComments: true,
        views: 3100,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/3-datos-de-la-novia-de-yamal-que-todas-las-mujeres-deben-conocer'
      },
      {
        id: '216',
        contentType: 'news',
        slug: 'por-que-los-defensores-le-tienen-tanto-miedo-a-yamal',
        titleEs: '¿Por qué los defensores le tienen tanto miedo a Yamal?',
        titleEn: 'Why defenders are so afraid of Yamal',
        excerptEs: 'El fenómeno del fútbol Lamine Yamal ha generado respeto y temor en la cancha.',
        excerptEn: 'Lamine Yamal\'s football phenomenon has generated respect and fear on the field.',
        contentEs: '<h1>El miedo de Yamal</h1><p>Los defensores han dado muestras de temor ante la velocidad, habilidad y determinación de Lamine Yamal.</p><h2>Factores técnicos</h2><p>Su capacidad para romper líneas defensivas y su precisión en el disparo lo convierten en un jugador temible.</p>',
        contentEn: '<h1>Yamal\'s fear factor</h1><p>Defenders have shown fear in the face of Lamine Yamal\'s speed, skill, and determination.</p><h2>Technical factors</h2><p>His ability to break defensive lines and precision in shooting make him a terrifying player.</p>',
        date: '2026-07-25',
        readTimeEs: '2 min de lectura',
        readTimeEn: '2 min read',
        imageUrl: 'https://badabun.com/images/yamal-defensores.jpg',
        imageCaption: 'Fotos en acción de Yamal',
        categoryEs: 'Deportes',
        categoryEn: 'Sports',
        enableComments: true,
        views: 2700,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/por-que-los-defensores-le-tienen-tanto-miedo-a-yamal'
      },
      {
        id: '217',
        contentType: 'news',
        slug: 'así-debes-cuidar-a-tu-familia-y-a-tus-perritos-durante-los-días-más-calientes-del-año',
        titleEs: 'Así debes cuidar a tu familia y a tus perritos durante los días más calientes del año',
        titleEn: 'This is how you should take care of your family and your dogs during the hottest days of the year',
        excerptEs: 'La temporada de calor requiere medidas especiales para la seguridad de personas y mascotas.',
        excerptEn: 'The hot season requires special measures for the safety of people and pets.',
        contentEs: '<h1>Protección contra el calor</h1><p>Los días más calientes del año pueden ser peligrosos, especialmente para niños, ancianos y mascotas.</p><h2>Consejos clave</h2><p>Buscar sombra, hidratación constante y evitar actividades prolongadas al sol son medidas esenciales.</p>',
        contentEn: '<h1>Protection against heat</h1><p>The hottest days of the year can be dangerous, especially for children, elderly, and pets.</p><h2>Key tips</h2><p>Seeking shade, constant hydration, and avoiding prolonged sun exposure are essential measures.</p>',
        date: '2026-07-25',
        readTimeEs: '3 min de lectura',
        readTimeEn: '3 min read',
        imageUrl: 'https://badabun.com/images/familia-perritos-calor.jpg',
        imageCaption: 'Fotos de familias y mascotas en días calurosos',
        categoryEs: 'Salud',
        categoryEn: 'Health',
        enableComments: true,
        views: 1890,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/así-debes-cuidar-a-tu-familia-y-a-tus-perritos-durante-los-días-más-calientes-del-año'
      },
      {
        id: '218',
        contentType: 'news',
        slug: 'es-campeon-del-mundo-y-cuando-no-esta-metiendo-goles-esta-rescatando-perritos',
        titleEs: 'Es campeón del mundo y cuando no está metiendo goles, está rescatando perritos',
        titleEn: 'He is world champion and when not scoring goals, he is rescuing dogs',
        excerptEs: 'El campeón mundial combina su carrera deportiva con actividades de rescate animal.',
        excerptEn: 'The world champion combines his sports career with animal rescue activities.',
        contentEs: '<h1>La doble vida del campeón</h1><p>Además de ser un futbolista de élite, este jugador destaca por su compromiso con el rescate de animales.</p><h2>Impacto positivo</h2><p>Su trabajo en el ámbito nocturno ha generado conciencia sobre la adopción responsable de mascotas.</p>',
        contentEn: '<h1>The double life of the champion</h1><p>In addition to being an elite footballer, this player stands out for his commitment to animal rescue.</p><h2>Positive impact</h2><p>His nighttime work has generated awareness about responsible pet adoption.</p>',
        date: '2026-07-25',
        readTimeEs: '3 min de lectura',
        readTimeEn: '3 min read',
        imageUrl: 'https://badabun.com/images/campeón-rescata-perritos.jpg',
        imageCaption: 'Fotos del campeón rescatando perritos',
        categoryEs: 'Deportes',
        categoryEn: 'Sports',
        enableComments: true,
        views: 4200,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/es-campeon-del-mundo-y-cuando-no-esta-metiendo-goles-esta-rescatando-perritos'
      },
      {
        id: '219',
        contentType: 'news',
        slug: 'sus-padres-cruzaron-el-desierto-sin-papeles-él-acaba-de-ganar-el-mundial',
        titleEs: 'Sus padres cruzaron el desierto sin papeles; él acaba de ganar el Mundial',
        titleEn: 'His parents crossed the desert without papers; he just won the World Cup',
        excerptEs: 'La historia de un futbolista migrante que conquistó el Mundial con una historia épica detrás.',
        excerptEn: 'The story of a migrant footballer who won the World Cup with an epic story behind it.',
        contentEs: '<h1>Una historia épica</h1><p>La travesía de los padres de este jugador a través del desierto sin documentos, y cómo su hijo conquistó el Mundial, es una historia de superación increíble.</p><h2>Legado familiar</h2><p>El éxito deportivo se convirtió en un símbolo de esperanza para comunidades migrantes.</p>',
        contentEn: '<h1>An epic story</h1><p>The journey of this player\'s parents through the desert without documents, and how his son won the World Cup, is an incredible story of overcoming.</p><h2>Family legacy</h2><p>Sports success became a symbol of hope for migrant communities.</p>',
        date: '2026-07-25',
        readTimeEs: '4 min de lectura',
        readTimeEn: '4 min read',
        imageUrl: 'https://badabun.com/images/padres-desierto.jpg',
        imageCaption: 'Fotos de la historia familiar inmigrante',
        categoryEs: 'Migración',
        categoryEn: 'Migration',
        enableComments: true,
        views: 3800,
        source: 'Badabun.com',
        sourceUrl: 'https://badabun.com/sus-padres-cruzaron-el-desierto-sin-papeles-él-acaba-de-ganar-el-mundial'
      },
      {
        id: '220',
        contentType: 'news',
        slug: 'mc-propone-que-diputados-también-trabajen-6-dias-para-que-aprendan',
        titleEs: 'MC propone que diputados también trabajen 6 días para que aprendan',
        titleEn: 'MC proposes that deputies also work 6 days so they can learn',
        excerptEs: 'Una propuesta política que ha generado debate sobre la jornada laboral de los legisladores.',
        excerptEn: 'A political proposal that has generated debate about the legislative workday.',
        contentEs: '<h1>Debate sobre la jornada legislativa</h1><p>La propuesta de MC de que los diputados trabajen 6 días a la semana ha levantado controversia.</p><h2>Argumentos a favor y en contra</h2><p>Quienes apoyan la medida ven en ella una forma de acercar a los legisladores al pueblo, mientras que otros la consideran excesiva.</p>',
        contentEn: '<h1>Debate on legislative session</h1><p>MC\'s proposal that deputies work 6 days a week has raised controversy.</p><h2>Arguments for and against</h2><p>Those who support the measure see it as a way to bring legislators closer to the people, while others consider it excessive.</p>',
        date: '2026-07-25',
        readTimeEs: '2 min de lectura',
        readTimeEn: '2 min read',
        imageUrl: 'https://badabun.com/images/diputados-trabajo.jpg',
        imageCaption: 'Fotos del Congreso y debates legislativos',
        categoryEs: 'Política',
        categoryEn: 'Politics',
        enableComments: true,
        views: 1450,
