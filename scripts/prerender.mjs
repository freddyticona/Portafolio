...
const ROUTES = ['/', '/sobre-mi', '/portafolio', '/cv', '/blog', '/noticias', '/guias', '/galeria', '/showreel', '/contacto', '/reservas', '/servicios', '/admin', '/eclipse-2026', '/reportaje-iran-furia-epica', '/reportaje-gaza-desarme', '/reportaje-ucrania-estancamiento'];
const PORT = 4173;
